		...
		<div>
			...
			<div className="container">
				...
				<div className="box">
					...
					<div className="contentBx">
						<h2>Projet Hackathon</h2>
						<p>Développement d'une application web sous ReactJS , basé sur l'API Windy, sur le thème de voyager depuis son canapé</p>
					</div>
				</div>
				<div className="box">
					<div className="imgBx">
					...
					<div className="contentBx">
						<h2>Projet Formation</h2>
						<p>Développement d'une application web sous ReactJS basé sur le thème des films d'horreurs</p>
					</div>
				</div>
				<div className="box">
					<div className="imgBx">
