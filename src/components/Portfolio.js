				...
				>
					<div className="box">
						...
						<div className="contentBx">
							<h2>GEEK TROTTER</h2>
							<p>
								Développement d'une application web, basé sur l'API Windy, sur le thème de voyager
								depuis son canapé
							</p>
				...
				>
					<div className="box">
						...
						<div className="contentBx">
							<h2>WILD CIRCUS</h2>
							<p>
								Développement d'un site sur le thème du cirque avec authentification et réservation en
								ligne
							</p>
